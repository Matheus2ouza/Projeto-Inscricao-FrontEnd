  ...
  return (
    <Background>
      <div className="h-full flex flex-col">
        {/* Main content */}
        <div className="flex-1 flex flex-col items-center justify-center p-4 min-h-0 -mt-8">
          {/* Logo acima do card */}
          <Logo />
          ...
          <div className="w-full max-w-md p-8 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl shadow-2xl rounded-2xl border border-white/30 dark:border-gray-700/30 hover:shadow-3xl transition-all duration-300">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  <i className="bi bi-geo-alt text-indigo-500 dark:text-blue-500 mr-2"></i>
                  Localidade
                </label>
              ...
              <div className="space-y-2">
                <label
                  ...
                  className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center text-transform: uppercase"
                >
                  <i className="bi bi-lock text-indigo-500 dark:text-blue-500 mr-2"></i>
                  Senha
                </label>
                <div className="relative">
                  <Input
              ...
              <div className="pt-4">
                <Button
                  className="w-full rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 dark:from-indigo-500 dark:to-purple-500 dark:hover:from-indigo-600 dark:hover:to-purple-600 py-3 px-6 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
                  type="submit"
                >
