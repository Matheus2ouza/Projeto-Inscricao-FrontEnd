...
import { useAnalysisPaymentsQuery } from "../hooks/useAnalysisInscriptionsQuery";
...
export default function PaymentsAnalysisTable() {
  ...
  const {
    ...
    isLoading: loading,
    error,
  } = useAnalysisPaymentsQuery(eventId, 1, 1000); // Buscar todos de uma vez
        ...
        {analysisData && sortedAccounts.length > 0 && (
          <div className="flex items-center gap-4 text-sm text-muted-foreground mb-4">
            ...
            <div className="hidden sm:flex items-center gap-2">
              ...
              <span>{totalPayments} pagamentos</span>
            </div>
          </div>
        )}
